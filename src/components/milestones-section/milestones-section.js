...
//     const achievedItems = document.querySelectorAll('.timeline__achiev').length;
//     const lookingItems = document.querySelectorAll('.timeline__looking').length;
//     const totalItems = achievedItems + lookingItems;
  ...
  function animateTl(scrolling, el, tl) {
    for (let i = 0; i < el.length; i++) {
      el[i].addEventListener('click', function () {
        ...
        const sign = this.classList.contains('arrow__prev') ? '' : '-';
        currentScroll += sign === '' ? scrolling : -scrolling;
